...
s 1. [Get certified, get seen.](#get-certified-get-seen)
...
I am not trying to paint a picture of doom for the AI industry, but to draw attention to the reality one has to graple with, especially in these parts of the world. Despite all this, I must say that there are a lot of quick wins out there that hinge on the right application of artificial intelligence and lots of testimonies to back this up too. My message here is that it is important to manage expectatons so as not to be disappointed. Furthermore, while knowing that it may not be an easy or a straightforward process as of 2020, one should undertake it anyway.
 ...
 {% include info.html text=" 'We do not do things because they are easy, but because they are hard.' 
 -John F. Kennedy, 1962" %}


## Machine Learning is a tool

The fact is that machine learning algorithms are but a means to an end. I have began to look at machine learning alorithms as a variety of mathematical concepts that have been condensed into reusable software in larger systems than themslves. This may seem obvious at first and maybe I did not realize this early on because I do not have a software background, but this shift in mindset was very important in my growth as I will explain shortly. 
...
Immediately this epiphany hit me, I took up programming in Flutter, expanded my Python curiosity from just Pytorch and Tensorflow to Django and Fast API, and invested my time heavily in cloud technology to mention but a few. This was difficult for me because I really enjiyed catching up on journals, but embarking on these learning paths seemed to be taking a whole lot of time. However, the rewards have been absolutely rewarding.

So there you have it for free -- Machine learning is but a very important piece of the entire jigsaw puzzle of whatever software you're building.

*i. Traditional software is used loosely here to mean software that does not have AI capabilities.*

## Documentation is vital

You know how when you hit a very massive bug in the course of development and it takes you several days before you eventually solve it? Then after you solve it, you proceed with the development as if nothing happened? Yeah, if I were you I'd never do that again.

Unfortunately, I learnt this lesson the hard way. Let me tell you the story of the bug that changed my coding life. While working on a side project that had caught my fancy - Face aging GANs. I had the misfortune to read a tutorial blogpost from a young lad whose name shall not be named (yeah, thanks a lot for nothing Derek). It was around the time when Tensrflow 2.0 came out and while a lot of the methods were backward compatible, there are quite a few that just aren't. I had started the project with a tf version of 1.15, but this tutorial just had to use the latest version of tensorflow. Due to limited choice, I tried to append a lot of his code, hoping and praying that it magically worked. Boy was I wrong. This led me on an excruciating two-day ordeal where I scoured the length and breadth of the internet trying to find the fix. To show how desperate  was, I found myself on the fourth page of Google's query page more than once.  No kidding.

Anyway, I finally figured out what the problem was - some modules in tensorflow 2.0 are incompatible with previous versions of tensorflow, and in order to make it compatible, you need to add a nifty import to make it backward compatible. I fixed the issue and moved on with my life. Everythig seemed rosy until I ran into the same issue some weeks later and wasted several productive hours trying to figure out the same issue. What made it so infuriating was that I knew I had faced the problem before, but I couldn't for the life of me remember the exact statement I had used in the import statement.

That very day, I decided to always include an "error_log.md" file in all future projects. Every time I find a solution to an error, I make sure to paste the link to the solution there alng with a small comment on what the problem was. This method has been a life saver in various unrelated projets.


## Polymath or Specialist
There is no easy way to put this. As a data scientist, you will most likely need to be a generalist. This is a harsh reality. Hold on a minute while I explain.

First of all, data Science applications cut across almost every professional field I know about. From Economics to Insurance, to Oil and Gas, to Education, to Philosophy, Language, Entertainment... the list goes on and on. To further confound this, some of the data generated in these fields are not mutually exclusive. By this I mean that the data generated in one field can influence the data generated in another field. As an example, imagine if your team is required to develop a prdeictive model to determine how the crop yield of Maize in Damaturu will impact Nigeria's GDP in 2021. It may somehow become your reponsibiity as a data scientist to analyze such inter-related data of Agriculture and Economics. Granted, either yourself or a member of your team may have background knowledge of one or both of the fields. However, in my experience that is seldom the case. Usually the only ways for you to effectively carry out your duties are:

1. Hire professionals who completely understand the related fields. Using our previous example - an expert of the agriculture landscape in Nigeria and a solid Economist. Without a doubt, this method is the most expensive in the short term, but could be the best method (in my opinion).
1. Some member of the team takes a crash course on the related field to understand the affected landscapes.
While this may be the cheaper alternative in the short term, it coud have disastrous effects on the kind of predictive model the team builds, if for example the wrong metric is used as a target variable for prediction.
In my experience, this is the method that is most explored. In that case, you could find yourself poring through your long-forgotten economics texts. 

As a second example, imagine a situation where a client needs a data science related task carried out but requires that the finished result be presented on a mobile application. Again, you or a member of your team may find themselves picking up a skill totally unrelated to data science in order to save the day for the organization.

These situations are not ideal, for sure. But the reality is that we do not live in an ideal world. Companies (at least in Nigeria) are not overly enthusiastic about hiring new hands, especially with the worsening economic climes.

So, if you have extra time on your hands, I would recommend that you consider expanding your portfolio.

## Learn how to learn.

I think it is important ton find what learning pattern works for you, and be dilligent in sticking to that pattern. This will keep the speed at which you absorb information steady and even speed it up in some cases. 
When I first started out, my major means of learning was by consuming hours upon hours of tutorial videos. I would browse through Andrew Ng's courses in days, pick up Udacity courses and follow through to the end. This worked for my friends and I for a while. At some point, I decided to try out reading a book that had been recommended on Twitter - Automating the boring stuff with Python and I became hooked on books. I managed to complete the text in 3 weeks and I discoverd that I retained the information a lot longer and had a more rounded understanding of the concepts than I would have had hah I watched it as a presentation.

Going forward, my first go-to method of learning has been books, documentation, tutorials. Where these are unavailable, and only then, do I succumb to watching videos. It's just not the same anymore.

You owe it to yourself to find the method that works for you and modify it as you go.
## Prioritizing interests

There are so many interesting things happening in the AI space all the time. It is easy to get drawn into a differnet from the one you started at the beginning of the week. I mean, there are sexy models being churned out all the time. Trust me, it is hard to say NO to some models some times. You just have to "quickly" try it out and use it in a project of your own. 

The problem with not explicitly saying NO is that one can get ovrwhelmed very easily. Before you know it, you're juggling 12 unfinished projects and haven't slept in 3 days.
